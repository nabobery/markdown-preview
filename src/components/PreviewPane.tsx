...
const PreviewPane: React.FC<PreviewPaneProps> = ({ content }) => {
  return (
    <div className="flex-1 flex flex-col bg-white min-h-0 shadow-sm">
      ...
      <div className="flex-1 overflow-auto bg-white min-h-0 relative flex flex-col">
        ...
        <div className="absolute top-0 left-0 right-0 h-4 bg-gradient-to-b from-gray-50/50 to-transparent pointer-events-none"></div>
      </div>
    </div>
  );
};
